...
class ContextualBallCatching(MujocoEnv, utils.EzPickle):
    def __init__(self,
        ...
        observation_space = spaces.Box(low=-10, high=10, shape=(15,), dtype=np.float64)
        MujocoEnv.__init__(self, xml_path, frame_skip= 5, observation_space=observation_space)
