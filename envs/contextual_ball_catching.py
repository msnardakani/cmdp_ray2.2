...
class ContextualBallCatching(MuJocoPyEnv, utils.EzPickle, TaskSettableEnv):
    ...
    def _set_action_space(self):
        ...
        self.action_space = spaces.Box(low=-scale_array, high=scale_array, dtype=np.float64)
    ...
    def reset_model(self):
        ...
        pos_noise[[0, 2]] = 0.
        vel_noise = self._reset_noise_scale * self.np_random.random(self.model.nv - 3)
        vel_noise[[0, 2]] = 0.
